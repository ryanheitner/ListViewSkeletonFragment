...
import rh.twitchtvclient.adapters.JustinTvStreamAdapter;
import rh.twitchtvclient.api.ApiClient;
...
public class MainActivity extends Activity {
    ...
    private void consumeApiData(List<JustinTvStreamData> justinTvStreamData) {
        if (justinTvStreamData != null) {
            ...
            for (JustinTvStreamData data : justinTvStreamData) {
